...
import org.fc.barebones.interpreter.language.command.DecrCommand;
 ...
 * Date: 25/10/13
 */
public class DecrCommandHandler extends BareboneHandler{
    @Override
    protected Pattern getPattern() {
        return Pattern.compile("^decr (.+);");
    }
    ...
    public Command getCommand(Statement s) {
        ...
        if(m.matches()) {
            return new DecrCommand(m.group(1));
        }
        return null;
    }
}
